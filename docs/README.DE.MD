...
> Hinweis: Codeblöcke, Befehle, Modellnamen, Paketnamen und Dateipfade werden absichtlich weitgehend unverändert beibehalten, um die direkte Nutzbarkeit zu erhalten.
...
**CheetahClaws** implementiert die gleiche Kernschleife in gut lesbarem Python neu: leichtgewichtig, hackbar, mehranbieterfähig und lokal lauffähig. Es behält, was nützlich ist, und verzichtet auf unnötige Komplexität. Mehr Details siehe hier: [English version](https://github.com/SafeRL-Lab/clawspring/blob/main/docs/comparison_claude_code_vs_nano_v3.03_en.md) and [Chinese version](https://github.com/SafeRL-Lab/clawspring/blob/main/docs/comparison_claude_code_vs_nano_v3.03_cn.md)
